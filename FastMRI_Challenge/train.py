...
def parse():
    ...
    parser.add_argument('-n', '--net-name', type=Path, default='test_varnet_4', help='Name of network')
    parser.add_argument('-t', '--data-path-train', type=Path, default='/content/drive/MyDrive/fastMRI_data/val/', help='Directory of train data')
    parser.add_argument('-v', '--data-path-val', type=Path, default='/content/drive/MyDrive/fastMRI_data/val/', help='Directory of validation data')
    ...
    parser.add_argument('--target-key', type=str, default='reconstruction_rss', help='Name of target key')
    parser.add_argument('--max-key', type=str, default='max', help='Name of max key in attributes')
    parser.add_argument('--seed', type=int, default=410, help='Fix random seed')
